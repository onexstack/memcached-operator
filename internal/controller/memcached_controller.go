...
import (
	...
	cachev1alpha1 "github.com/onexstack/memcached-operator/api/v1alpha1"
)
...
// +kubebuilder:rbac:groups=cache.onexstack.com,resources=memcacheds,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=cache.onexstack.com,resources=memcacheds/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=cache.onexstack.com,resources=memcacheds/finalizers,verbs=update
